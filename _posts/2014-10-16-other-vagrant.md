---
layout: post
title: 使用Vagrant在Windows下部署开发环境
thread: 19
categories: 其他
tags: 其他
keywords: Vagrant,虚拟化, Vagrantfile
description: 使用Vagrant在Windows下部署开发环境
---
...
目前所选用的是当前的最新版本Vagrant 1.6.5 （对应的Vagrantfile V2版），VirtualBox 使用的是 4.3.18

##准备工作：

* 下载安装 VirtualBox ：[https://www.virtualbox.org/](https://www.virtualbox.org/)

* 下载安装 Vagrant ：[http://www.vagrantup.com/downloads.html](http://www.vagrantup.com/downloads.html)
...
>
>更多信息可以参考官方文档：[http://docs.vagrantup.com/v2/](http://docs.vagrantup.com/v2/)
>